...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<table class="table" style="margin: 5px 3px 3px;">
		<tr class="perluas">
			<td><?php echo $form->labelEx($model,'NIK'); ?></td>
			<td><?php echo $form->textField($model,'nik',array('class'=>'span3', 'size'=>16,'maxlength'=>16)); ?>
...
<?php echo $form->passwordFieldRow($model, 'nama', array('class'=>'span3')); ?>
